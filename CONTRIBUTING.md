<!-- This entire file was based off a template and should be rewtitten but to be honest I am too lazy as this is a small project -->
...
[Code of Conduct](https://github.com/ArcticWarmth/html2mrkdwn/main/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. Please report unacceptable behavior
to <abuse@arcticwarmth.net>.

## I Have a Question

Before you ask a question, it is best to search for existing [Discussions](https://github.com/ArcticWarmth/html2mrkdwn/discussions) that might help you. In case you have found a suitable discussion and still need clarification, you can write your question in this discussion. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [discussion](https://github.com/ArcticWarmth/DisableEnd/issues/new).
- Provide as much context as you can about what you're running into (Error messages, list of installed modules).
- Provide node and module versions
...
A good bug report shouldn't leave others needing more info from you as that slows down the bug fixing process. Therefore, we ask you to investigate carefully, collect information and describe the issue in detail in your report. Please complete the following steps in advance to help us fix any potential bug as fast as possible.

- Make sure that you are using the latest version.
- Determine if your bug is really a bug and not an error in your code e.g. trying to parse non HTML content. If you are looking for support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/ArcticWarmth/html2mrkdwn/issues?q=label%3Abug).
- Collect information about the bug:
  - Stack trace
  - Version of node and this module
  - Surrounding code
...
- Open an [Issue](https://github.com/ArcticWarmth/html2mrkdwn/issues/new).
...
The recomended IDE for development is VSCode. To start development clone the repo and open the project in VSCode.

#### Runing and building

 To test your code make a new folder called "test" and within that folder run `npm init -y` then `npm install ../`. To build run `npm run build`.
